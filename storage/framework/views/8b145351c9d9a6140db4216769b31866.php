...
<header class="navbar navbar-fixed-top bg-primary p-0 shadow">
  ...
  <ul class="nav navbar-nav navbar-right">
    ...
    <img class="user m-2"src="/img/top-navbar/user.png" alt="..." style="width:35px;">  
      ...
      <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2" href="/user/data" style="color:black;">
...
<main class="content col-lg-10 ">
  ...
  <center>
    <div class="count border-bottom">
      <img src="/img/dashboard/classcount.png " style="width:380px;  margin:5px 0px;">
        <div class="text1" style="color:white; position:absolute; size:20px; top:250px; left:27.3%;">
          <h1>25</h1>
        </div>
      <img src="/img/dashboard/studentcount.png " style="width:380px;  margin:5px 0px;">
        <div class="text1" style="color:white; position:absolute; size:20px; top:250px; left:52.3%;">
          <h1>76</h1>
        </div>
      <img src="/img/dashboard/teachercount.png " style="width:380px;  margin:5px 0px;">
...
<div id="carouselExampleIndicators" class="carousel slide" style="width:70%; margin:40px 10px;">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="/img/dashboard/slider/slidesatu.jpeg" class="d-block w-100">
    </div>
    <div class="carousel-item">
      <img src="/img/dashboard/slider/slidedua.jpeg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="/img/dashboard/slider/slidetiga.jpeg" class="d-block w-100" alt="...">
    </div>
  </div>
...
<?php /**PATH D:\Laravel\sistem-akademik\resources\views//user/dashboard.blade.php ENDPATH**/ ?>