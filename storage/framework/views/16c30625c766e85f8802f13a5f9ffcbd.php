        ...
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              ...
              <a class="nav-link d-flex align-items-center gap-2 active" aria-current="page" href="/user/dashboard" style="color:black;">
...
<div class="foto m-4">
  <img src="/img/biodata/heri.jpeg" alt="..." style="width:150px;">
</div>

<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 m-3">
<h1 class="h2"></h1>
  <div class="col-auto">
    <button type="button" style="background-color:yellow;">Edit Biodata</button>
  </div>
...
<h5>Data Diri</h5>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>MAGELANG, 4 November 2002</td>
    </tr>
    <tr>
      <td>Jenis Kelamin</td>
      <td>Laki-Laki</td>
...
<?php /**PATH D:\Laravel\sistem-akademik\resources\views//user/data.blade.php ENDPATH**/ ?>