...
<main class="content col-lg-10 ">
  <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1>Selamat Datang, Sutrisno</h1>
  </div>

  <center>
    <div class="count border-bottom">
      <img src="classcount.png " style="width:380px;  margin:5px 0px;">
        <div class="text1" style="color:white; position:absolute; size:20px; top:250px; left:33%;">
          <h1>25</h1>
        </div>
      ...
      <img src="teachercount.png " style="width:380px;  margin:5px 0px;">
        <div class="text1" style="color:white; position:absolute; size:20px; top:250px; left:73.5%;">
          <h1>12</h1>
        </div>
    </div> 
  </center>
